...
WebUI.setText(findTestObject('Object Repository/Page_Amazon Sign-In/input_Email or mobile phone number_email'), 'Harshithunny11@gmail.com')

WebUI.click(findTestObject('Object Repository/Page_Amazon Sign-In/input_Wrong or Invalid email address or mob_77ed40'))

WebUI.setEncryptedText(findTestObject('Object Repository/Page_Amazon Sign-In/input_Forgot password_password'), 'hUQCGF8Jx0gIvg3fD636Yg==')
